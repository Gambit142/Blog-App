...
RSpec.describe 'Post Index Page Features', type: :feature, js: true do
  ...
  before :each do
    ...
    click_button 'Log in'
    post1 = Post.create(id: 4, title: 'post 1', text: 'text 1', likes_counters: 0, comments_counter: 0,
                        user_id: @user1.id)
    post2 = Post.create(id: 5, title: 'post 2', text: 'text 2', likes_counters: 0, comments_counter: 0,
                        user_id: @user1.id)
